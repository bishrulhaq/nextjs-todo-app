...
const ToDo = ({ session, handleSignOut }) =>   {
        ...
        <section>
          <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto">
            ...
            <div className="w-full p-6 bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md dark:bg-gray-800 dark:border-gray-700 sm:p-8 mb-2">
              <h1 className="self-center text-2xl font-semibold whitespace-nowrap text-gray-900 dark:text-white pb-3">Hello, {session.user.name ?? session.user.name}</h1>
